...
namespace VersioningManagement.Commands
{
    ...
    public class DecreaseMajorVersionCommand : ICommand
    {
        ...
        public bool CanExecute(object parameter)
        {
            ...
            return oldVersion.Major != default(int);
        }
        ...
        {
            parameter.As<ProjectViewModel>().IsNotNull(p => Versioning.DecreaseMajorVersion(p.AssemblyInfoVersion.Version));
        }
