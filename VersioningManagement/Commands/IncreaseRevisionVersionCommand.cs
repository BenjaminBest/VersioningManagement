...
namespace VersioningManagement.Commands
{
    ...
    public class IncreaseRevisionVersionCommand : ICommand
    {
        ...
        {
            parameter.As<ProjectViewModel>().IsNotNull(p => Versioning.IncreaseRevisionVersion(p.AssemblyInfoVersion.Version));
        }
