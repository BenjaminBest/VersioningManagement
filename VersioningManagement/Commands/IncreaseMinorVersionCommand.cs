...
{
    /// <summary>
    /// The command is responsible for changing the minor version
    /// </summary>
    /// <seealso cref="ICommand" />
    public class IncreaseMinorVersionCommand : ICommand
    {
        ...
        {
            parameter.As<ProjectViewModel>().IsNotNull(p => Versioning.IncreaseMinorVersion(p.AssemblyInfoVersion.Version));
        }
